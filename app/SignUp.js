        ...
        <div className='flex items-center justify-center mt-[50px] mx-10 mx-auto'>
            ...
            <div>
                <div className='border border-gray-300 w-[500px] h-[800px] '>
                    ...
                    <div className='flex items-center justify-center text-[22px] font-semibold text-gray-500'>Đăng ký để xem ảnh và video từ bạn</div>
                    <div className='flex items-center justify-center text-[22px] font-semibold text-gray-500'>be.</div>
                ...
                <div className='flex border items-center justify-center border-gray-300 mt-10 w-[500px] h-[90px] '>
                    ...
                    <p className='text-xl font-bold text-blue-500 hover:text-blue-800 ml-2 cursor-pointer'>Dang Nhap</p>
                </div>
