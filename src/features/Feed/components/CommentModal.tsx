    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <ModalContent>
        ...
        <div className='flex w-fit h-fit'>
          <div className='bg-gray-200 w-[200px] h-[640px]'>
          ...
          <div className='bg-white w-[400px] h-[640px]'>
            <div>
              <div className="flex items-center py-3 border-b-[1px]">
                <img
                  src={'https://images.contentstack.io/v3/assets/bltb6530b271fddd0b1/blt100d13bfa8286a3d/5eb7cdc11ea0c32e33b95fa2/V_AGENTS_587x900_Breach.png'}
